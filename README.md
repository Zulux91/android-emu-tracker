...
| 12 | Winlator Coffincolors | 785.9K | `winlator_cmod_update_december_2025` | Winlator |
| 13 | RPCSX Android | 776.3K | `v20250425` | Emulator PS3 |
| 14 | Flycast | 738.0K | `v2.6` | Sega Dreamcast |
| 15 | Dolphin MMJR2 VBI | 721.1K | `U24.07.02-2407` | Nintendo GameCube / Wii |
| 16 | GameNative | 709.1K | `v1.1.1-prerelease` | GameNative |
| 17 | Winlator Afei | 699.4K | `10.1hotfix-Amod3fix2` | Winlator |
| 18 | XoDos | 691.5K | `1.0.3-link` | PC Emulator |
| 19 | Freedreno Turnip CI (Weab-chan) | 653.7K | `25.3.0-devel_bbdd688` | Drivers |
| 20 | APS3e | 526.3K | `2.40` | Emulator PS3 |
| 21 | Winlator Mali | 493.0K | `bionic-mali-1.1` | Winlator |
| 22 | Horizon Emu | 464.6K | `v4` | PC Emulator |
| 23 | Freedreno Turnip CI (whitebelyash) | 455.0K | `tu_v29` | Drivers |
| 24 | Freedreno Turnip CI (StevenMXZ) | 370.8K | `v863.1_a7xx` | Drivers |
| 25 | Wb64dev | 277.0K | `v10.2` | Winlator |
| 26 | BannerHub (The412Banner) | 234.8K | `v3.8.0` | GameHub |
| 27 | X360 Mobile | 205.5K | `v0.5.3_preview` | Xbox 360 |
| 28 | ExaGear 302 | 152.3K | `v3.0.2.2-egw` | PC Emulator |
| 29 | NetherSX2-Turnip | 132.2K | `v0.7` | Emulator PS2 |
...
| 33 | Winlator Ajay | 82.8K | `v11.1-hotfix2` | Winlator |
...
| 38 | ARMSX2 | 67.5K | `2.6.5` | Emulator PS2 |
| 39 | Winlator Ref4ik (Drivers/Wine) | 60.6K | `V10Hotfix` | Drivers |
| 40 | Winlator Ref4ik | 60.6K | `V10Hotfix` | Winlator |
...
_Last auto-generated: 2026-07-24T08:15:43.250Z_
