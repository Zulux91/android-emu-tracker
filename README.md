...
| 12 | Winlator Coffincolors | 770.0K | `winlator_cmod_update_december_2025` | Winlator |
| 13 | RPCSX Android | 757.0K | `v20250425` | Emulator PS3 |
...
| 17 | XoDos | 675.3K | `1.0.3-link` | PC Emulator |
| 18 | GameNative | 661.6K | `v1.1.0` | GameNative |
| 19 | Freedreno Turnip CI (Weab-chan) | 635.4K | `25.3.0-devel_bbdd688` | Drivers |
| 20 | APS3e | 499.2K | `2.40` | Emulator PS3 |
| 21 | Winlator Mali | 460.7K | `bionic-mali-1.0` | Winlator |
| 22 | Horizon Emu | 460.4K | `v4` | PC Emulator |
| 23 | Freedreno Turnip CI (whitebelyash) | 417.7K | `tu_v29` | Drivers |
| 24 | Freedreno Turnip CI (StevenMXZ) | 332.6K | `v863.1_a7xx` | Drivers |
| 25 | Wb64dev | 272.7K | `v10.2` | Winlator |
| 26 | BannerHub (The412Banner) | 206.0K | `v3.8.0` | GameHub |
| 27 | X360 Mobile | 170.6K | `v0.5.3_preview` | Xbox 360 |
| 28 | ExaGear 302 | 147.5K | `v3.0.2.2-egw` | PC Emulator |
| 29 | NetherSX2-Turnip | 113.8K | `v0.7` | Emulator PS2 |
...
| 41 | ARMSX2 | 43.6K | `2.5.7` | Emulator PS2 |
...
_Last auto-generated: 2026-07-08T05:36:09.604Z_
