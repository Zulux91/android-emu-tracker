...
| 12 | Winlator Coffincolors | 779.9K | `winlator_cmod_update_december_2025` | Winlator |
| 13 | RPCSX Android | 768.6K | `v20250425` | Emulator PS3 |
| 14 | Flycast | 730.9K | `v2.6` | Sega Dreamcast |
| 15 | Dolphin MMJR2 VBI | 716.9K | `U24.07.02-2407` | Nintendo GameCube / Wii |
| 16 | Winlator Afei | 695.7K | `10.1hotfix-Amod3fix2` | Winlator |
| 17 | XoDos | 685.5K | `1.0.3-link` | PC Emulator |
| 18 | GameNative | 684.5K | `v1.1.1-prerelease` | GameNative |
| 19 | Freedreno Turnip CI (Weab-chan) | 646.4K | `25.3.0-devel_bbdd688` | Drivers |
| 20 | APS3e | 515.8K | `2.40` | Emulator PS3 |
...
| 24 | Freedreno Turnip CI (StevenMXZ) | 341.9K | `v863.1_a7xx` | Drivers |
| 25 | Wb64dev | 275.4K | `v10.2` | Winlator |
| 26 | BannerHub (The412Banner) | 223.8K | `v3.8.0` | GameHub |
| 27 | X360 Mobile | 191.9K | `v0.5.3_preview` | Xbox 360 |
| 28 | ExaGear 302 | 150.5K | `v3.0.2.2-egw` | PC Emulator |
| 29 | NetherSX2-Turnip | 125.0K | `v0.7` | Emulator PS2 |
...
| 34 | Lemuroid | 78.0K | `1.17.0` | All In One |
| 35 | hakuX | 76.9K | `v0.3.1` | Xbox |
| 36 | MiceWine | 76.3K | `ba4b91b` | PC Emulator |
| 37 | Winlator X | 73.7K | `v3.0.1-beta` | Winlator |
| 38 | ARMSX2 | 66.6K | `2.6.1.2` | Emulator PS2 |
...
_Last auto-generated: 2026-07-17T22:13:32.831Z_
