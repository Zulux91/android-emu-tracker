...
| 11 | Winlator Glibc | 998.0K | `v7.1.5` | Winlator |
| 12 | Winlator Coffincolors | 783.8K | `winlator_cmod_update_december_2025` | Winlator |
| 13 | RPCSX Android | 773.5K | `v20250425` | Emulator PS3 |
| 14 | Flycast | 735.1K | `v2.6` | Sega Dreamcast |
| 15 | Dolphin MMJR2 VBI | 719.5K | `U24.07.02-2407` | Nintendo GameCube / Wii |
| 16 | GameNative | 700.3K | `v1.1.1-prerelease` | GameNative |
| 17 | Winlator Afei | 698.1K | `10.1hotfix-Amod3fix2` | Winlator |
| 18 | XoDos | 689.4K | `1.0.3-link` | PC Emulator |
| 19 | Freedreno Turnip CI (Weab-chan) | 650.8K | `25.3.0-devel_bbdd688` | Drivers |
| 20 | APS3e | 522.5K | `2.40` | Emulator PS3 |
| 21 | Winlator Mali | 488.3K | `bionic-mali-1.1` | Winlator |
| 22 | Horizon Emu | 464.1K | `v4` | PC Emulator |
| 23 | Freedreno Turnip CI (whitebelyash) | 449.6K | `tu_v29` | Drivers |
| 24 | Freedreno Turnip CI (StevenMXZ) | 359.8K | `v863.1_a7xx` | Drivers |
| 25 | Wb64dev | 276.3K | `v10.2` | Winlator |
| 26 | BannerHub (The412Banner) | 230.4K | `v3.8.0` | GameHub |
| 27 | X360 Mobile | 200.0K | `v0.5.3_preview` | Xbox 360 |
...
| 31 | Star (fork) | 98.9K | `star-winhub-progrwss` | Winlator |
...
| 38 | ARMSX2 | 62.4K | `2.6.4.1` | Emulator PS2 |
| 39 | Winlator Bionic jhinzuo | 60.3K | `dev8` | Winlator |
| 40 | Winlator Ref4ik (Drivers/Wine) | 59.3K | `V10Hotfix` | Drivers |
| 41 | Winlator Ref4ik | 59.3K | `V10Hotfix` | Winlator |
...
_Last auto-generated: 2026-07-21T19:11:10.414Z_
