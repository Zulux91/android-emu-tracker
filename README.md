...
| 12 | Winlator Coffincolors | 800.6K | `winlator_cmod_update_december_2025` | Winlator |
| 13 | RPCSX Android | 799.2K | `v20250425` | Emulator PS3 |
| 14 | GameNative | 765.0K | `v1.1.1` | GameNative |
| 15 | Flycast | 763.0K | `v2.6` | Sega Dreamcast |
| 16 | Dolphin MMJR2 VBI | 734.2K | `U24.07.02-2407` | Nintendo GameCube / Wii |
| 17 | XoDos | 708.3K | `1.0.3-link` | PC Emulator |
| 18 | Winlator Afei | 708.2K | `10.1hotfix-Amod3fix2` | Winlator |
| 19 | Freedreno Turnip CI (Weab-chan) | 677.3K | `25.3.0-devel_bbdd688` | Drivers |
| 20 | APS3e | 578.3K | `2.41` | Emulator PS3 |
| 21 | Winlator Mali | 529.3K | `bionic-mali-1.1` | Winlator |
| 22 | Freedreno Turnip CI (whitebelyash) | 495.6K | `tu_v31` | Drivers |
| 23 | Horizon Emu | 469.3K | `v4` | PC Emulator |
| 24 | Freedreno Turnip CI (StevenMXZ) | 434.0K | `v863.1_a7xx` | Drivers |
| 25 | X360 Mobile | 286.7K | `v0.6.1` | Xbox 360 |
| 26 | Wb64dev | 282.2K | `v10.2` | Winlator |
| 27 | BannerHub (The412Banner) | 267.7K | `v3.8.0` | GameHub |
| 28 | ARMSX2 | 189.6K | `2.6.6.6` | Emulator PS2 |
| 29 | ExaGear 302 | 157.4K | `v3.0.2.2-egw` | PC Emulator |
| 30 | NetherSX2-Turnip | 155.2K | `v0.7` | Emulator PS2 |
| 31 | Winlator Bionic Stredohiri | 120.2K | `26f65e9` | Winlator |
| 32 | Star (fork) | 105.1K | `star-winhub-progrwss` | Winlator |
| 33 | Pluvia | 98.8K | `v1.3.2` | PC Emulator |
| 34 | hakuX | 96.5K | `v0.3.1` | Xbox |
...
| 39 | Winlator Ref4ik (Drivers/Wine) | 68.6K | `V11` | Drivers |
| 40 | Winlator Ref4ik | 68.6K | `V11` | Winlator |
| 41 | X1 BOX | 65.8K | `1.2.6` | Xbox |
...
_Last auto-generated: 2026-08-14T01:23:04.830Z_
