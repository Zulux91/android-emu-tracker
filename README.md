...
| 12 | Winlator Coffincolors | 776.4K | `winlator_cmod_update_december_2025` | Winlator |
| 13 | RPCSX Android | 764.0K | `v20250425` | Emulator PS3 |
| 14 | Flycast | 726.4K | `v2.6` | Sega Dreamcast |
| 15 | Dolphin MMJR2 VBI | 714.1K | `U24.07.02-2407` | Nintendo GameCube / Wii |
| 16 | Winlator Afei | 693.7K | `10.1hotfix-Amod3fix2` | Winlator |
| 17 | GameNative | 683.1K | `v1.1.0` | GameNative |
| 18 | XoDos | 681.0K | `1.0.3-link` | PC Emulator |
| 19 | Freedreno Turnip CI (Weab-chan) | 641.9K | `25.3.0-devel_bbdd688` | Drivers |
| 20 | APS3e | 508.9K | `2.40` | Emulator PS3 |
| 21 | Winlator Mali | 472.0K | `bionic-mali-1.1` | Winlator |
| 22 | Horizon Emu | 462.0K | `v4` | PC Emulator |
| 23 | Freedreno Turnip CI (whitebelyash) | 431.4K | `tu_v29` | Drivers |
| 24 | Freedreno Turnip CI (StevenMXZ) | 341.3K | `v863.1_a7xx` | Drivers |
| 25 | Wb64dev | 274.2K | `v10.2` | Winlator |
| 26 | BannerHub (The412Banner) | 216.4K | `v3.8.0` | GameHub |
| 27 | X360 Mobile | 183.1K | `v0.5.3_preview` | Xbox 360 |
| 28 | ExaGear 302 | 149.3K | `v3.0.2.2-egw` | PC Emulator |
| 29 | NetherSX2-Turnip | 120.1K | `v0.7` | Emulator PS2 |
...
| 34 | Lemuroid | 77.4K | `1.17.0` | All In One |
| 35 | MiceWine | 76.0K | `ba4b91b` | PC Emulator |
| 36 | hakuX | 75.3K | `v0.3.1` | Xbox |
| 37 | Winlator X | 73.3K | `v3.0.1-beta` | Winlator |
| 38 | ARMSX2 | 60.6K | `nightly-20260713` | Emulator PS2 |
| 39 | Winlator Bionic jhinzuo | 59.3K | `dev8` | Winlator |
| 40 | Steamlator | 56.9K | `1.7` | Winlator |
...
_Last auto-generated: 2026-07-13T18:29:10.844Z_
