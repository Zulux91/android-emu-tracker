...
| 11 | Winlator Glibc | 993.7K | `v7.1.5` | Winlator |
| 12 | Winlator Coffincolors | 775.1K | `winlator_cmod_update_december_2025` | Winlator |
| 13 | RPCSX Android | 762.2K | `v20250425` | Emulator PS3 |
...
| 18 | GameNative | 677.7K | `v1.1.0` | GameNative |
| 19 | Freedreno Turnip CI (Weab-chan) | 640.2K | `25.3.0-devel_bbdd688` | Drivers |
| 20 | APS3e | 506.4K | `2.40` | Emulator PS3 |
| 21 | Winlator Mali | 469.2K | `bionic-mali-1.1` | Winlator |
| 22 | Horizon Emu | 461.6K | `v4` | PC Emulator |
| 23 | Freedreno Turnip CI (whitebelyash) | 428.1K | `tu_v29` | Drivers |
| 24 | Freedreno Turnip CI (StevenMXZ) | 335.8K | `v863.1_a7xx` | Drivers |
| 25 | Wb64dev | 273.9K | `v10.2` | Winlator |
| 26 | BannerHub (The412Banner) | 213.8K | `v3.8.0` | GameHub |
| 27 | X360 Mobile | 179.8K | `v0.5.3_preview` | Xbox 360 |
| 28 | ExaGear 302 | 148.8K | `v3.0.2.2-egw` | PC Emulator |
| 29 | NetherSX2-Turnip | 118.4K | `v0.7` | Emulator PS2 |
...
| 40 | ARMSX2 | 55.5K | `2.5.7` | Emulator PS2 |
...
_Last auto-generated: 2026-07-12T10:52:50.882Z_
