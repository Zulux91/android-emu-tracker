...
| 10 | Winlator Ludashi | 992.9K | `v3.1.h` | Winlator |
| 11 | Winlator Glibc | 989.5K | `v7.1.5` | Winlator |
| 12 | Winlator Coffincolors | 765.8K | `winlator_cmod_update_december_2025` | Winlator |
| 13 | RPCSX Android | 751.6K | `v20250425` | Emulator PS3 |
| 14 | Flycast | 716.3K | `v2.6` | Sega Dreamcast |
...
| 18 | GameNative | 642.4K | `v1.1.0` | GameNative |
| 19 | Freedreno Turnip CI (Weab-chan) | 630.6K | `25.3.0-devel_bbdd688` | Drivers |
| 20 | APS3e | 491.0K | `2.40` | Emulator PS3 |
| 21 | Horizon Emu | 459.1K | `v4` | PC Emulator |
| 22 | Winlator Mali | 452.7K | `bionic-mali-1.0` | Winlator |
| 23 | Freedreno Turnip CI (whitebelyash) | 407.5K | `tu_v29` | Drivers |
| 24 | Freedreno Turnip CI (StevenMXZ) | 315.7K | `v863.1_a7xx` | Drivers |
| 25 | Wb64dev | 271.6K | `v10.2` | Winlator |
| 26 | BannerHub (The412Banner) | 198.2K | `v3.8.0` | GameHub |
| 27 | X360 Mobile | 161.5K | `v0.5.3_preview` | Xbox 360 |
...
| 42 | ARMSX2 | 37.6K | `2.5.1` | Emulator PS2 |
...
_Last auto-generated: 2026-07-03T20:37:51.150Z_
