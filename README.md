...
| 13 | RPCSX Android | 803.0K | `v20250425` | Emulator PS3 |
| 14 | GameNative | 775.1K | `v1.1.1` | GameNative |
| 15 | Flycast | 767.8K | `v2.6` | Sega Dreamcast |
| 16 | Dolphin MMJR2 VBI | 736.4K | `U24.07.02-2407` | Nintendo GameCube / Wii |
| 17 | XoDos | 711.4K | `1.0.3-link` | PC Emulator |
| 18 | Winlator Afei | 709.8K | `10.1hotfix-Amod3fix2` | Winlator |
| 19 | Freedreno Turnip CI (Weab-chan) | 681.1K | `25.3.0-devel_bbdd688` | Drivers |
| 20 | APS3e | 586.2K | `2.41` | Emulator PS3 |
| 21 | Winlator Mali | 535.5K | `bionic-mali-1.1` | Winlator |
| 22 | Freedreno Turnip CI (whitebelyash) | 506.9K | `tu_v31` | Drivers |
| 23 | Horizon Emu | 470.2K | `v4` | PC Emulator |
| 24 | Freedreno Turnip CI (StevenMXZ) | 455.2K | `v863.1_a7xx` | Drivers |
| 25 | X360 Mobile | 313.9K | `v0.6.2-public.hotfix.1` | Xbox 360 |
| 26 | Wb64dev | 282.9K | `v10.2` | Winlator |
| 27 | BannerHub (The412Banner) | 273.0K | `v3.8.0` | GameHub |
| 28 | ARMSX2 | 210.4K | `2.6.6.7` | Emulator PS2 |
| 29 | NetherSX2-Turnip | 159.5K | `v0.7` | Emulator PS2 |
| 30 | ExaGear 302 | 158.4K | `v3.0.2.2-egw` | PC Emulator |
| 31 | Winlator Bionic Stredohiri | 121.3K | `26f65e9` | Winlator |
| 32 | Star (fork) | 106.1K | `star-winhub-progrwss` | Winlator |
| 33 | hakuX | 99.6K | `v0.3.1` | Xbox |
...
| 39 | X1 BOX | 74.0K | `1.2.6` | Xbox |
| 40 | Winlator Ref4ik (Drivers/Wine) | 70.2K | `V11` | Drivers |
| 41 | Winlator Ref4ik | 70.2K | `V11` | Winlator |
...
_Last auto-generated: 2026-08-17T10:26:46.517Z_
