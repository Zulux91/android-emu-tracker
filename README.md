...
![Last update](https://img.shields.io/badge/updated-2026-07-27-9dff57?style=flat-square)
...
| 7 | Azahar | 2.3M | `2126.0-rc4` | Nintendo 3DS |
...
| 12 | Winlator Coffincolors | 788.5K | `winlator_cmod_update_december_2025` | Winlator |
| 13 | RPCSX Android | 780.3K | `v20250425` | Emulator PS3 |
| 14 | Flycast | 741.9K | `v2.6` | Sega Dreamcast |
| 15 | Dolphin MMJR2 VBI | 723.3K | `U24.07.02-2407` | Nintendo GameCube / Wii |
| 16 | GameNative | 706.6K | `v1.1.1` | GameNative |
| 17 | Winlator Afei | 701.0K | `10.1hotfix-Amod3fix2` | Winlator |
| 18 | XoDos | 694.3K | `1.0.3-link` | PC Emulator |
| 19 | Freedreno Turnip CI (Weab-chan) | 658.0K | `25.3.0-devel_bbdd688` | Drivers |
| 20 | APS3e | 531.3K | `2.40` | Emulator PS3 |
| 21 | Winlator Mali | 499.6K | `bionic-mali-1.1` | Winlator |
| 22 | Horizon Emu | 465.4K | `v4` | PC Emulator |
| 23 | Freedreno Turnip CI (whitebelyash) | 463.3K | `tu_v29` | Drivers |
| 24 | Freedreno Turnip CI (StevenMXZ) | 387.3K | `v863.1_a7xx` | Drivers |
| 25 | Wb64dev | 277.9K | `v10.2` | Winlator |
| 26 | BannerHub (The412Banner) | 240.9K | `v3.8.0` | GameHub |
| 27 | X360 Mobile | 213.2K | `v0.5.3_preview` | Xbox 360 |
| 28 | ExaGear 302 | 153.2K | `v3.0.2.2-egw` | PC Emulator |
| 29 | NetherSX2-Turnip | 136.1K | `v0.7` | Emulator PS2 |
| 30 | Winlator Bionic Stredohiri | 114.7K | `26f65e9` | Winlator |
| 31 | Star (fork) | 100.7K | `star-winhub-progrwss` | Winlator |
| 32 | Pluvia | 98.5K | `v1.3.2` | PC Emulator |
| 33 | Winlator Ajay | 83.5K | `v11.1-hotfix2` | Winlator |
| 34 | hakuX | 82.4K | `v0.3.1` | Xbox |
| 35 | Lemuroid | 79.7K | `1.17.0` | All In One |
| 36 | MiceWine | 77.4K | `ba4b91b` | PC Emulator |
| 37 | Winlator X | 74.9K | `v3.0.1-beta` | Winlator |
| 38 | Winlator Ref4ik (Drivers/Wine) | 62.3K | `V10Hotfix` | Drivers |
| 39 | Winlator Ref4ik | 62.3K | `V10Hotfix` | Winlator |
| 40 | Winlator Bionic jhinzuo | 60.6K | `dev8` | Winlator |
| 41 | Steamlator | 58.9K | `1.7` | Winlator |
| 42 | ARMSX2 | 58.5K | `2.6.5.7-1` | Emulator PS2 |
| 43 | X1 BOX | 47.6K | `1.2.5` | Xbox |
| 44 | Adrenotools Drivers (StevenMXZ) | 46.7K | `v849` | Drivers |
...
| 55 | GameHub Lite (J4MCU-builds) | 672 | `V5.1.3` | GameHub |
...
_Last auto-generated: 2026-07-27T15:58:19.116Z_
