...
| 12 | Winlator Coffincolors | 780.6K | `winlator_cmod_update_december_2025` | Winlator |
| 13 | RPCSX Android | 769.6K | `v20250425` | Emulator PS3 |
| 14 | Flycast | 731.8K | `v2.6` | Sega Dreamcast |
| 15 | Dolphin MMJR2 VBI | 717.5K | `U24.07.02-2407` | Nintendo GameCube / Wii |
| 16 | Winlator Afei | 696.1K | `10.1hotfix-Amod3fix2` | Winlator |
| 17 | GameNative | 688.4K | `v1.1.1-prerelease` | GameNative |
| 18 | XoDos | 686.4K | `1.0.3-link` | PC Emulator |
| 19 | Freedreno Turnip CI (Weab-chan) | 647.1K | `25.3.0-devel_bbdd688` | Drivers |
| 20 | APS3e | 517.3K | `2.40` | Emulator PS3 |
| 21 | Winlator Mali | 482.2K | `bionic-mali-1.1` | Winlator |
| 22 | Horizon Emu | 463.2K | `v4` | PC Emulator |
| 23 | Freedreno Turnip CI (whitebelyash) | 442.7K | `tu_v29` | Drivers |
| 24 | Freedreno Turnip CI (StevenMXZ) | 345.5K | `v863.1_a7xx` | Drivers |
| 25 | Wb64dev | 275.6K | `v10.2` | Winlator |
| 26 | BannerHub (The412Banner) | 225.2K | `v3.8.0` | GameHub |
| 27 | X360 Mobile | 193.5K | `v0.5.3_preview` | Xbox 360 |
| 28 | ExaGear 302 | 150.7K | `v3.0.2.2-egw` | PC Emulator |
| 29 | NetherSX2-Turnip | 126.0K | `v0.7` | Emulator PS2 |
...
| 36 | MiceWine | 76.4K | `ba4b91b` | PC Emulator |
| 37 | Winlator X | 73.8K | `v3.0.1-beta` | Winlator |
| 38 | ARMSX2 | 66.2K | `2.6.1.3` | Emulator PS2 |
| 39 | Winlator Bionic jhinzuo | 59.9K | `dev8` | Winlator |
| 40 | Steamlator | 57.6K | `1.7` | Winlator |
| 41 | Winlator Ref4ik (Drivers/Wine) | 56.9K | `V10` | Drivers |
| 42 | Winlator Ref4ik | 56.9K | `V10` | Winlator |
| 43 | Adrenotools Drivers (StevenMXZ) | 46.1K | `v849` | Drivers |
| 44 | X1 BOX | 43.3K | `1.2.5` | Xbox |
...
_Last auto-generated: 2026-07-18T17:52:31.777Z_
