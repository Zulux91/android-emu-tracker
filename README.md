...
| 11 | Winlator Glibc | 991.1K | `v7.1.5` | Winlator |
| 12 | Winlator Coffincolors | 769.0K | `winlator_cmod_update_december_2025` | Winlator |
| 13 | RPCSX Android | 755.8K | `v20250425` | Emulator PS3 |
| 14 | Flycast | 719.4K | `v2.6` | Sega Dreamcast |
| 15 | Dolphin MMJR2 VBI | 709.6K | `U24.07.02-2407` | Nintendo GameCube / Wii |
| 16 | Winlator Afei | 688.7K | `10.1hotfix-Amod3fix2` | Winlator |
| 17 | XoDos | 674.4K | `1.0.3-link` | PC Emulator |
| 18 | GameNative | 657.4K | `v1.1.0` | GameNative |
| 19 | Freedreno Turnip CI (Weab-chan) | 634.2K | `25.3.0-devel_bbdd688` | Drivers |
| 20 | APS3e | 497.3K | `2.40` | Emulator PS3 |
| 21 | Horizon Emu | 460.1K | `v4` | PC Emulator |
| 22 | Winlator Mali | 458.9K | `bionic-mali-1.0` | Winlator |
| 23 | Freedreno Turnip CI (whitebelyash) | 415.0K | `tu_v29` | Drivers |
| 24 | Freedreno Turnip CI (StevenMXZ) | 328.3K | `v863.1_a7xx` | Drivers |
| 25 | Wb64dev | 272.4K | `v10.2` | Winlator |
| 26 | BannerHub (The412Banner) | 203.8K | `v3.8.0` | GameHub |
| 27 | X360 Mobile | 168.1K | `v0.5.3_preview` | Xbox 360 |
| 28 | ExaGear 302 | 147.1K | `v3.0.2.2-egw` | PC Emulator |
| 29 | NetherSX2-Turnip | 112.5K | `v0.7` | Emulator PS2 |
...
| 34 | Lemuroid | 76.4K | `1.17.0` | All In One |
| 35 | MiceWine | 75.2K | `ba4b91b` | PC Emulator |
| 36 | hakuX | 72.8K | `v0.3.1` | Xbox |
| 37 | Winlator X | 72.6K | `v3.0.1-beta` | Winlator |
| 38 | Winlator Bionic jhinzuo | 57.9K | `dev8` | Winlator |
| 39 | Steamlator | 55.9K | `1.7` | Winlator |
| 40 | Adrenotools Drivers (StevenMXZ) | 45.3K | `v849` | Drivers |
| 41 | ARMSX2 | 39.7K | `2.5.6` | Emulator PS2 |
| 42 | X1 BOX | 38.6K | `1.2.5` | Xbox |
...
_Last auto-generated: 2026-07-07T01:15:56.289Z_
