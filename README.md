...
| 9 | Winlator Glibc | 983.5K | `v7.1.5` | Winlator |
| 10 | GameHub Lite (Producdevity) | 980.6K | `v5.1.7` | GameHub |
| 11 | Winlator Ludashi | 942.9K | `3.1` | Winlator |
| 12 | Winlator Coffincolors | 755.2K | `winlator_cmod_update_december_2025` | Winlator |
| 13 | RPCSX Android | 737.9K | `v20250425` | Emulator PS3 |
| 14 | Flycast | 705.7K | `v2.6` | Sega Dreamcast |
| 15 | Dolphin MMJR2 VBI | 699.7K | `U24.07.02-2407` | Nintendo GameCube / Wii |
| 16 | Winlator Afei | 678.8K | `10.1hotfix-Amod3fix2` | Winlator |
| 17 | XoDos | 659.6K | `1.0.3-link` | PC Emulator |
| 18 | GameNative | 626.8K | `v1.0.0` | GameNative |
| 19 | Freedreno Turnip CI (Weab-chan) | 616.6K | `25.3.0-devel_bbdd688` | Drivers |
| 20 | APS3e | 473.4K | `2.39` | Emulator PS3 |
| 21 | Horizon Emu | 455.7K | `v4` | PC Emulator |
| 22 | Winlator Mali | 442.2K | `test` | Winlator |
| 23 | Freedreno Turnip CI (whitebelyash) | 378.4K | `tu_v29` | Drivers |
| 24 | Freedreno Turnip CI (StevenMXZ) | 275.7K | `v863.1_a7xx` | Drivers |
| 25 | Wb64dev | 268.9K | `v10.2` | Winlator |
| 26 | BannerHub (The412Banner) | 179.4K | `v3.8.0` | GameHub |
| 27 | ExaGear 302 | 142.8K | `v3.0.2.2-egw` | PC Emulator |
| 28 | X360 Mobile | 133.6K | `v0.5.3_preview` | Xbox 360 |
| 29 | Winlator Bionic Stredohiri | 103.2K | `26f65e9` | Winlator |
| 30 | Pluvia | 97.7K | `v1.3.2` | PC Emulator |
| 31 | NetherSX2-Turnip | 96.9K | `v0.7` | Emulator PS2 |
| 32 | Star (fork) | 86.7K | `1.3` | Winlator |
| 33 | Winlator Ajay | 76.0K | `v11.1-hotfix2` | Winlator |
| 34 | Lemuroid | 74.2K | `1.17.0` | All In One |
| 35 | MiceWine | 73.3K | `ba4b91b` | PC Emulator |
| 36 | Winlator X | 71.0K | `v3.0.1-beta` | Winlator |
| 37 | hakuX | 68.0K | `v0.3.1` | Xbox |
| 38 | Winlator Bionic jhinzuo | 55.2K | `dev8` | Winlator |
| 39 | Steamlator | 53.6K | `1.7` | Winlator |
| 40 | Winlator Ref4ik (Drivers/Wine) | 52.0K | `v9` | Drivers |
| 41 | Winlator Ref4ik | 52.0K | `v9` | Winlator |
| 42 | Adrenotools Drivers (StevenMXZ) | 44.2K | `v849` | Drivers |
| 43 | X1 BOX | 35.0K | `1.2.5` | Xbox |
| 44 | Winlator Honkon | 26.2K | `V11.1` | Winlator |
| 45 | ARMSX2 | 23.5K | `2.3.4` | Emulator PS2 |
...
_Last auto-generated: 2026-06-22T13:31:31.255Z_
