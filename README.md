...
![Last update](https://img.shields.io/badge/updated-2026-07-04-9dff57?style=flat-square)
...
| 7 | Azahar | 2.6M | `2125.1.3` | Nintendo 3DS |
| 8 | NetherSX2 Classic | 1.2M | `2.2n` | Emulator PS2 |
| 9 | GameHub Lite (Producdevity) | 1.0M | `v5.1.8` | GameHub |
| 10 | Winlator Ludashi | 997.2K | `v3.1.h` | Winlator |
| 11 | Winlator Glibc | 990.0K | `v7.1.5` | Winlator |
| 12 | Winlator Coffincolors | 766.6K | `winlator_cmod_update_december_2025` | Winlator |
| 13 | RPCSX Android | 752.9K | `v20250425` | Emulator PS3 |
| 14 | Flycast | 717.3K | `v2.6` | Sega Dreamcast |
| 15 | Dolphin MMJR2 VBI | 708.0K | `U24.07.02-2407` | Nintendo GameCube / Wii |
| 16 | Winlator Afei | 687.2K | `10.1hotfix-Amod3fix2` | Winlator |
| 17 | XoDos | 672.2K | `1.0.3-link` | PC Emulator |
| 18 | GameNative | 647.7K | `v1.1.0` | GameNative |
| 19 | Freedreno Turnip CI (Weab-chan) | 631.7K | `25.3.0-devel_bbdd688` | Drivers |
| 20 | APS3e | 493.1K | `2.40` | Emulator PS3 |
| 21 | Horizon Emu | 459.4K | `v4` | PC Emulator |
| 22 | Winlator Mali | 454.9K | `bionic-mali-1.0` | Winlator |
| 23 | Freedreno Turnip CI (whitebelyash) | 409.8K | `tu_v29` | Drivers |
| 24 | Freedreno Turnip CI (StevenMXZ) | 319.7K | `v863.1_a7xx` | Drivers |
| 25 | Wb64dev | 271.8K | `v10.2` | Winlator |
| 26 | BannerHub (The412Banner) | 199.8K | `v3.8.0` | GameHub |
| 27 | X360 Mobile | 163.5K | `v0.5.3_preview` | Xbox 360 |
| 28 | ExaGear 302 | 146.3K | `v3.0.2.2-egw` | PC Emulator |
| 29 | NetherSX2-Turnip | 110.2K | `v0.7` | Emulator PS2 |
| 30 | Winlator Bionic Stredohiri | 107.4K | `26f65e9` | Winlator |
| 31 | Pluvia | 98.0K | `v1.3.2` | PC Emulator |
| 32 | Star (fork) | 92.1K | `1.3` | Winlator |
| 33 | Winlator Ajay | 78.5K | `v11.1-hotfix2` | Winlator |
| 34 | Lemuroid | 76.1K | `1.17.0` | All In One |
| 35 | MiceWine | 75.0K | `ba4b91b` | PC Emulator |
| 36 | Winlator X | 72.4K | `v3.0.1-beta` | Winlator |
| 37 | hakuX | 72.0K | `v0.3.1` | Xbox |
| 38 | Winlator Bionic jhinzuo | 57.8K | `dev8` | Winlator |
| 39 | Steamlator | 55.5K | `1.7` | Winlator |
| 40 | Adrenotools Drivers (StevenMXZ) | 45.1K | `v849` | Drivers |
| 41 | ARMSX2 | 41.2K | `2.5.2` | Emulator PS2 |
| 42 | X1 BOX | 38.0K | `1.2.5` | Xbox |
| 43 | Winlator Honkon | 27.1K | `V11.1` | Winlator |
...
| 53 | GameHub Lite (J4MCU-builds) | 656 | `V5.1.3` | GameHub |
...
_Last auto-generated: 2026-07-04T19:44:27.058Z_
