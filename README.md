...
| 7 | Azahar | 2.4M | `2126.0` | Nintendo 3DS |
...
| 13 | RPCSX Android | 795.6K | `v20250425` | Emulator PS3 |
| 14 | Flycast | 758.5K | `v2.6` | Sega Dreamcast |
| 15 | GameNative | 755.5K | `v1.1.1` | GameNative |
| 16 | Dolphin MMJR2 VBI | 732.2K | `U24.07.02-2407` | Nintendo GameCube / Wii |
| 17 | Winlator Afei | 706.9K | `10.1hotfix-Amod3fix2` | Winlator |
| 18 | XoDos | 705.8K | `1.0.3-link` | PC Emulator |
| 19 | Freedreno Turnip CI (Weab-chan) | 673.8K | `25.3.0-devel_bbdd688` | Drivers |
| 20 | APS3e | 570.4K | `2.41` | Emulator PS3 |
| 21 | Winlator Mali | 523.8K | `bionic-mali-1.1` | Winlator |
| 22 | Freedreno Turnip CI (whitebelyash) | 484.8K | `tu_v31` | Drivers |
| 23 | Horizon Emu | 468.6K | `v4` | PC Emulator |
| 24 | Freedreno Turnip CI (StevenMXZ) | 415.8K | `v863.1_a7xx` | Drivers |
| 25 | Wb64dev | 281.5K | `v10.2` | Winlator |
| 26 | X360 Mobile | 265.8K | `v0.6.0` | Xbox 360 |
| 27 | BannerHub (The412Banner) | 263.1K | `v3.8.0` | GameHub |
| 28 | ARMSX2 | 157.6K | `2.6.6.5` | Emulator PS2 |
| 29 | ExaGear 302 | 156.6K | `v3.0.2.2-egw` | PC Emulator |
| 30 | NetherSX2-Turnip | 151.3K | `v0.7` | Emulator PS2 |
...
| 34 | hakuX | 93.1K | `v0.3.1` | Xbox |
| 35 | Winlator Ajay | 86.4K | `v11.1-hotfix2` | Winlator |
| 36 | Lemuroid | 82.0K | `1.17.0` | All In One |
| 37 | MiceWine | 78.9K | `ba4b91b` | PC Emulator |
| 38 | Winlator X | 76.7K | `v3.0.1-beta` | Winlator |
...
| 44 | Adrenotools Drivers (StevenMXZ) | 47.7K | `v849` | Drivers |
...
_Last auto-generated: 2026-08-10T17:46:23.009Z_
