...
| 11 | Winlator Glibc | 996.8K | `v7.1.5` | Winlator |
| 12 | Winlator Coffincolors | 781.2K | `winlator_cmod_update_december_2025` | Winlator |
| 13 | RPCSX Android | 770.6K | `v20250425` | Emulator PS3 |
| 14 | Flycast | 732.7K | `v2.6` | Sega Dreamcast |
| 15 | Dolphin MMJR2 VBI | 718.0K | `U24.07.02-2407` | Nintendo GameCube / Wii |
| 16 | Winlator Afei | 696.3K | `10.1hotfix-Amod3fix2` | Winlator |
| 17 | GameNative | 691.7K | `v1.1.1-prerelease` | GameNative |
| 18 | XoDos | 687.1K | `1.0.3-link` | PC Emulator |
| 19 | Freedreno Turnip CI (Weab-chan) | 647.9K | `25.3.0-devel_bbdd688` | Drivers |
| 20 | APS3e | 518.7K | `2.40` | Emulator PS3 |
| 21 | Winlator Mali | 483.6K | `bionic-mali-1.1` | Winlator |
| 22 | Horizon Emu | 463.4K | `v4` | PC Emulator |
| 23 | Freedreno Turnip CI (whitebelyash) | 444.3K | `tu_v29` | Drivers |
| 24 | Freedreno Turnip CI (StevenMXZ) | 348.5K | `v863.1_a7xx` | Drivers |
| 25 | Wb64dev | 275.7K | `v10.2` | Winlator |
| 26 | BannerHub (The412Banner) | 226.4K | `v3.8.0` | GameHub |
| 27 | X360 Mobile | 195.0K | `v0.5.3_preview` | Xbox 360 |
...
| 38 | ARMSX2 | 69.5K | `2.6.1.3` | Emulator PS2 |
| 39 | Winlator Bionic jhinzuo | 60.0K | `dev8` | Winlator |
| 40 | Steamlator | 57.8K | `1.7` | Winlator |
| 41 | Winlator Ref4ik (Drivers/Wine) | 57.7K | `V10Hotfix` | Drivers |
| 42 | Winlator Ref4ik | 57.7K | `V10Hotfix` | Winlator |
| 43 | Adrenotools Drivers (StevenMXZ) | 46.2K | `v849` | Drivers |
| 44 | X1 BOX | 43.7K | `1.2.5` | Xbox |
...
| 56 | Winlator Xmod | 513 | `Winlator_xmox_1.1.0` | Winlator |
...
_Last auto-generated: 2026-07-19T10:51:18.877Z_
