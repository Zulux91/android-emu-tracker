...
| 11 | Winlator Glibc | 996.0K | `v7.1.5` | Winlator |
...
| 14 | Flycast | 730.6K | `v2.6` | Sega Dreamcast |
| 15 | Dolphin MMJR2 VBI | 716.7K | `U24.07.02-2407` | Nintendo GameCube / Wii |
| 16 | Winlator Afei | 695.6K | `10.1hotfix-Amod3fix2` | Winlator |
| 17 | XoDos | 685.3K | `1.0.3-link` | PC Emulator |
| 18 | GameNative | 683.1K | `v1.1.1-prerelease` | GameNative |
| 19 | Freedreno Turnip CI (Weab-chan) | 646.1K | `25.3.0-devel_bbdd688` | Drivers |
| 20 | APS3e | 515.4K | `2.40` | Emulator PS3 |
| 21 | Winlator Mali | 480.2K | `bionic-mali-1.1` | Winlator |
| 22 | Horizon Emu | 462.9K | `v4` | PC Emulator |
| 23 | Freedreno Turnip CI (whitebelyash) | 440.5K | `tu_v29` | Drivers |
| 24 | Freedreno Turnip CI (StevenMXZ) | 340.9K | `v863.1_a7xx` | Drivers |
| 25 | Wb64dev | 275.3K | `v10.2` | Winlator |
| 26 | BannerHub (The412Banner) | 223.4K | `v3.8.0` | GameHub |
| 27 | X360 Mobile | 191.3K | `v0.5.3_preview` | Xbox 360 |
| 28 | ExaGear 302 | 150.4K | `v3.0.2.2-egw` | PC Emulator |
| 29 | NetherSX2-Turnip | 124.7K | `v0.7` | Emulator PS2 |
| 30 | Winlator Bionic Stredohiri | 111.7K | `26f65e9` | Winlator |
| 31 | Pluvia | 98.3K | `v1.3.2` | PC Emulator |
| 32 | Star (fork) | 97.3K | `1.3` | Winlator |
| 33 | Winlator Ajay | 81.3K | `v11.1-hotfix2` | Winlator |
| 34 | Lemuroid | 78.0K | `1.17.0` | All In One |
| 35 | hakuX | 76.8K | `v0.3.1` | Xbox |
| 36 | MiceWine | 76.3K | `ba4b91b` | PC Emulator |
| 37 | Winlator X | 73.7K | `v3.0.1-beta` | Winlator |
| 38 | ARMSX2 | 65.5K | `2.6.1.2` | Emulator PS2 |
| 39 | Winlator Bionic jhinzuo | 59.9K | `dev8` | Winlator |
| 40 | Steamlator | 57.5K | `1.7` | Winlator |
| 41 | Winlator Ref4ik (Drivers/Wine) | 55.9K | `V10` | Drivers |
| 42 | Winlator Ref4ik | 55.9K | `V10` | Winlator |
...
_Last auto-generated: 2026-07-17T17:07:13.803Z_
