...
| 12 | Flycast | 853.8K | `v2.7` | Sega Dreamcast |
| 13 | RPCSX Android | 839.7K | `v20250425` | Emulator PS3 |
| 14 | GameNative | 834.5K | `v1.2.1` | GameNative |
| 15 | Winlator Coffincolors | 833.3K | `winlator_cmod_update_december_2025` | Winlator |
| 16 | Dolphin MMJR2 VBI | 763.3K | `U24.07.02-2407` | Nintendo GameCube / Wii |
| 17 | XoDos | 744.3K | `1.0.3-link` | PC Emulator |
| 18 | Winlator Afei | 725.5K | `10.1hotfix-Amod3fix2` | Winlator |
| 19 | Freedreno Turnip CI (Weab-chan) | 723.1K | `25.3.0-devel_bbdd688` | Drivers |
| 20 | Freedreno Turnip CI (StevenMXZ) | 659.8K | `v863.1_a7xx` | Drivers |
| 21 | APS3e | 658.9K | `2.42` | Emulator PS3 |
| 22 | Winlator Mali | 608.9K | `bionic-mali-1.1` | Winlator |
| 23 | Freedreno Turnip CI (whitebelyash) | 605.6K | `tu_v32` | Drivers |
| 24 | Horizon Emu | 482.5K | `v4` | PC Emulator |
| 25 | X360 Mobile | 471.8K | `v0.6.3` | Xbox 360 |
| 26 | ARMSX2 | 372.7K | `2.7.1` | Emulator PS2 |
| 27 | BannerHub (The412Banner) | 325.7K | `v3.8.1` | GameHub |
| 28 | Wb64dev | 292.6K | `v10.2` | Winlator |
| 29 | NetherSX2-Turnip | 205.0K | `v0.7` | Emulator PS2 |
| 30 | ExaGear 302 | 168.2K | `v3.0.2.2-egw` | PC Emulator |
| 31 | X1 BOX | 133.3K | `1.2.8` | Xbox |
| 32 | Winlator Bionic Stredohiri | 131.7K | `26f65e9` | Winlator |
| 33 | hakuX | 128.7K | `v0.3.1` | Xbox |
| 34 | Star (fork) | 115.0K | `star-winhub-progrwss` | Winlator |
| 35 | Pluvia | 99.6K | `v1.3.2` | PC Emulator |
| 36 | Winlator Ajay | 95.1K | `v11.1-hotfix2` | Winlator |
...
_Last auto-generated: 2026-09-26T11:37:26.563Z_
