...
![Last update](https://img.shields.io/badge/updated-2026-07-14-9dff57?style=flat-square)
...
| 11 | Winlator Glibc | 994.5K | `v7.1.5` | Winlator |
| 12 | Winlator Coffincolors | 776.6K | `winlator_cmod_update_december_2025` | Winlator |
| 13 | RPCSX Android | 764.3K | `v20250425` | Emulator PS3 |
| 14 | Flycast | 726.8K | `v2.6` | Sega Dreamcast |
| 15 | Dolphin MMJR2 VBI | 714.3K | `U24.07.02-2407` | Nintendo GameCube / Wii |
| 16 | Winlator Afei | 693.8K | `10.1hotfix-Amod3fix2` | Winlator |
| 17 | GameNative | 684.2K | `v1.1.0` | GameNative |
| 18 | XoDos | 681.2K | `1.0.3-link` | PC Emulator |
| 19 | Freedreno Turnip CI (Weab-chan) | 642.2K | `25.3.0-devel_bbdd688` | Drivers |
| 20 | APS3e | 509.4K | `2.40` | Emulator PS3 |
| 21 | Winlator Mali | 472.6K | `bionic-mali-1.1` | Winlator |
| 22 | Horizon Emu | 462.1K | `v4` | PC Emulator |
| 23 | Freedreno Turnip CI (whitebelyash) | 432.0K | `tu_v29` | Drivers |
| 24 | Freedreno Turnip CI (StevenMXZ) | 342.1K | `v863.1_a7xx` | Drivers |
| 25 | Wb64dev | 274.3K | `v10.2` | Winlator |
| 26 | BannerHub (The412Banner) | 216.9K | `v3.8.0` | GameHub |
| 27 | X360 Mobile | 183.8K | `v0.5.3_preview` | Xbox 360 |
| 28 | ExaGear 302 | 149.4K | `v3.0.2.2-egw` | PC Emulator |
| 29 | NetherSX2-Turnip | 120.5K | `v0.7` | Emulator PS2 |
| 30 | Winlator Bionic Stredohiri | 110.6K | `26f65e9` | Winlator |
| 31 | Pluvia | 98.2K | `v1.3.2` | PC Emulator |
| 32 | Star (fork) | 95.9K | `1.3` | Winlator |
| 33 | Winlator Ajay | 80.5K | `v11.1-hotfix2` | Winlator |
...
| 38 | ARMSX2 | 62.4K | `nightly-20260713` | Emulator PS2 |
...
| 43 | Adrenotools Drivers (StevenMXZ) | 45.9K | `v849` | Drivers |
| 44 | X1 BOX | 41.0K | `1.2.5` | Xbox |
...
_Last auto-generated: 2026-07-14T00:14:30.228Z_
