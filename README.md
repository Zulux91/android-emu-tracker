...
| 11 | Winlator Glibc | 997.4K | `v7.1.5` | Winlator |
| 12 | Winlator Coffincolors | 782.7K | `winlator_cmod_update_december_2025` | Winlator |
| 13 | RPCSX Android | 771.8K | `v20250425` | Emulator PS3 |
| 14 | Flycast | 733.8K | `v2.6` | Sega Dreamcast |
| 15 | Dolphin MMJR2 VBI | 718.6K | `U24.07.02-2407` | Nintendo GameCube / Wii |
| 16 | Winlator Afei | 697.5K | `10.1hotfix-Amod3fix2` | Winlator |
| 17 | GameNative | 695.5K | `v1.1.1-prerelease` | GameNative |
| 18 | XoDos | 688.2K | `1.0.3-link` | PC Emulator |
| 19 | Freedreno Turnip CI (Weab-chan) | 649.1K | `25.3.0-devel_bbdd688` | Drivers |
| 20 | APS3e | 520.4K | `2.40` | Emulator PS3 |
| 21 | Winlator Mali | 485.7K | `bionic-mali-1.1` | Winlator |
| 22 | Horizon Emu | 463.7K | `v4` | PC Emulator |
| 23 | Freedreno Turnip CI (whitebelyash) | 446.6K | `tu_v29` | Drivers |
| 24 | Freedreno Turnip CI (StevenMXZ) | 353.0K | `v863.1_a7xx` | Drivers |
| 25 | Wb64dev | 276.0K | `v10.2` | Winlator |
| 26 | BannerHub (The412Banner) | 228.2K | `v3.8.0` | GameHub |
| 27 | X360 Mobile | 197.2K | `v0.5.3_preview` | Xbox 360 |
| 28 | ExaGear 302 | 151.2K | `v3.0.2.2-egw` | PC Emulator |
| 29 | NetherSX2-Turnip | 127.9K | `v0.7` | Emulator PS2 |
...
| 35 | hakuX | 78.2K | `v0.3.1` | Xbox |
| 36 | MiceWine | 76.7K | `ba4b91b` | PC Emulator |
| 37 | Winlator X | 74.0K | `v3.0.1-beta` | Winlator |
| 38 | ARMSX2 | 71.0K | `2.6.3` | Emulator PS2 |
| 39 | Winlator Bionic jhinzuo | 60.1K | `dev8` | Winlator |
...
_Last auto-generated: 2026-07-20T11:21:20.873Z_
