...
| 9 | Winlator Glibc | 983.4K | `v7.1.5` | Winlator |
| 10 | GameHub Lite (Producdevity) | 979.6K | `v5.1.7` | GameHub |
| 11 | Winlator Ludashi | 940.9K | `3.1` | Winlator |
| 12 | Winlator Coffincolors | 755.0K | `winlator_cmod_update_december_2025` | Winlator |
| 13 | RPCSX Android | 737.6K | `v20250425` | Emulator PS3 |
| 14 | Flycast | 705.6K | `v2.6` | Sega Dreamcast |
| 15 | Dolphin MMJR2 VBI | 699.5K | `U24.07.02-2407` | Nintendo GameCube / Wii |
| 16 | Winlator Afei | 678.7K | `10.1hotfix-Amod3fix2` | Winlator |
| 17 | XoDos | 659.3K | `1.0.3-link` | PC Emulator |
| 18 | GameNative | 626.3K | `v1.0.0` | GameNative |
| 19 | Freedreno Turnip CI (Weab-chan) | 616.3K | `25.3.0-devel_bbdd688` | Drivers |
| 20 | APS3e | 473.1K | `2.39` | Emulator PS3 |
| 21 | Horizon Emu | 455.6K | `v4` | PC Emulator |
| 22 | Winlator Mali | 442.0K | `test` | Winlator |
| 23 | Freedreno Turnip CI (whitebelyash) | 377.6K | `tu_v29` | Drivers |
| 24 | Freedreno Turnip CI (StevenMXZ) | 274.5K | `v863.1_a7xx` | Drivers |
| 25 | Wb64dev | 268.8K | `v10.2` | Winlator |
| 26 | BannerHub (The412Banner) | 179.0K | `v3.8.0` | GameHub |
| 27 | ExaGear 302 | 142.7K | `v3.0.2.2-egw` | PC Emulator |
| 28 | X360 Mobile | 133.0K | `v0.5.3_preview` | Xbox 360 |
| 29 | Winlator Bionic Stredohiri | 103.1K | `26f65e9` | Winlator |
| 30 | Pluvia | 97.7K | `v1.3.2` | PC Emulator |
| 31 | NetherSX2-Turnip | 96.7K | `v0.7` | Emulator PS2 |
| 32 | Star (fork) | 86.5K | `1.3` | Winlator |
...
| 37 | hakuX | 68.0K | `v0.3.1` | Xbox |
| 38 | Winlator Bionic jhinzuo | 55.2K | `dev8` | Winlator |
| 39 | Steamlator | 53.6K | `1.7` | Winlator |
...
| 45 | ARMSX2 | 22.9K | `2.3.4` | Emulator PS2 |
...
_Last auto-generated: 2026-06-22T07:34:41.424Z_
