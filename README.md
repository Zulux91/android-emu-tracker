...
| 12 | GameNative | 844.0K | `v1.2.1-prerelease` | GameNative |
| 13 | RPCSX Android | 824.5K | `v20250425` | Emulator PS3 |
| 14 | Flycast | 823.4K | `v2.7` | Sega Dreamcast |
| 15 | Winlator Coffincolors | 820.8K | `winlator_cmod_update_december_2025` | Winlator |
| 16 | Dolphin MMJR2 VBI | 751.3K | `U24.07.02-2407` | Nintendo GameCube / Wii |
| 17 | XoDos | 730.8K | `1.0.3-link` | PC Emulator |
| 18 | Winlator Afei | 719.1K | `10.1hotfix-Amod3fix2` | Winlator |
| 19 | Freedreno Turnip CI (Weab-chan) | 704.2K | `25.3.0-devel_bbdd688` | Drivers |
| 20 | APS3e | 620.9K | `2.42` | Emulator PS3 |
| 21 | Winlator Mali | 574.7K | `bionic-mali-1.1` | Winlator |
| 22 | Freedreno Turnip CI (whitebelyash) | 573.9K | `tu_v31` | Drivers |
| 23 | Freedreno Turnip CI (StevenMXZ) | 537.3K | `v863.1_a7xx` | Drivers |
| 24 | Horizon Emu | 476.7K | `v4` | PC Emulator |
| 25 | X360 Mobile | 413.4K | `v0.6.3` | Xbox 360 |
| 26 | ARMSX2 | 311.9K | `nightly-20260908` | Emulator PS2 |
| 27 | BannerHub (The412Banner) | 308.9K | `v3.8.0` | GameHub |
| 28 | Wb64dev | 287.4K | `v10.2` | Winlator |
| 29 | NetherSX2-Turnip | 186.0K | `v0.7` | Emulator PS2 |
| 30 | ExaGear 302 | 163.7K | `v3.0.2.2-egw` | PC Emulator |
| 31 | Winlator Bionic Stredohiri | 127.4K | `26f65e9` | Winlator |
| 32 | hakuX | 116.2K | `v0.3.1` | Xbox |
| 33 | Star (fork) | 111.7K | `star-winhub-progrwss` | Winlator |
| 34 | X1 BOX | 111.5K | `1.2.7` | Xbox |
...
| 40 | Winlator Ref4ik (Drivers/Wine) | 78.1K | `V11` | Drivers |
| 41 | Winlator Ref4ik | 78.1K | `V11` | Winlator |
...
_Last auto-generated: 2026-09-08T17:00:26.194Z_
