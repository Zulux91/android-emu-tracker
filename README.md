...
![Last update](https://img.shields.io/badge/updated-2026-08-28-9dff57?style=flat-square)
...
| 12 | RPCSX Android | 814.3K | `v20250425` | Emulator PS3 |
| 13 | Winlator Coffincolors | 812.5K | `winlator_cmod_update_december_2025` | Winlator |
| 14 | Flycast | 802.3K | `v2.7` | Sega Dreamcast |
| 15 | GameNative | 799.6K | `v1.2.0` | GameNative |
| 16 | Dolphin MMJR2 VBI | 743.9K | `U24.07.02-2407` | Nintendo GameCube / Wii |
| 17 | XoDos | 721.3K | `1.0.3-link` | PC Emulator |
| 18 | Winlator Afei | 714.7K | `10.1hotfix-Amod3fix2` | Winlator |
| 19 | Freedreno Turnip CI (Weab-chan) | 692.1K | `25.3.0-devel_bbdd688` | Drivers |
| 20 | APS3e | 606.9K | `2.41` | Emulator PS3 |
| 21 | Winlator Mali | 554.5K | `bionic-mali-1.1` | Winlator |
| 22 | Freedreno Turnip CI (whitebelyash) | 541.1K | `tu_v31` | Drivers |
| 23 | Freedreno Turnip CI (StevenMXZ) | 487.5K | `v863.1_a7xx` | Drivers |
| 24 | Horizon Emu | 473.1K | `v4` | PC Emulator |
| 25 | X360 Mobile | 372.4K | `v0.6.3` | Xbox 360 |
| 26 | BannerHub (The412Banner) | 290.7K | `v3.8.0` | GameHub |
| 27 | Wb64dev | 285.1K | `v10.2` | Winlator |
| 28 | ARMSX2 | 265.0K | `nightly-20260828` | Emulator PS2 |
| 29 | NetherSX2-Turnip | 173.1K | `v0.7` | Emulator PS2 |
| 30 | ExaGear 302 | 161.1K | `v3.0.2.2-egw` | PC Emulator |
| 31 | Winlator Bionic Stredohiri | 124.5K | `26f65e9` | Winlator |
| 32 | Star (fork) | 109.2K | `star-winhub-progrwss` | Winlator |
| 33 | hakuX | 108.4K | `v0.3.1` | Xbox |
| 34 | X1 BOX | 99.3K | `1.2.7` | Xbox |
| 35 | Pluvia | 99.1K | `v1.3.2` | PC Emulator |
| 36 | Winlator Ajay | 90.1K | `v11.1-hotfix2` | Winlator |
| 37 | Lemuroid | 85.5K | `1.17.0` | All In One |
| 38 | MiceWine | 81.0K | `ba4b91b` | PC Emulator |
| 39 | Winlator X | 78.8K | `v3.0.1-beta` | Winlator |
| 40 | Winlator Ref4ik (Drivers/Wine) | 74.7K | `V11` | Drivers |
| 41 | Winlator Ref4ik | 74.7K | `V11` | Winlator |
...
| 60 | Eden Emulator Nightly | 0 | `v1787882247.119291dc77` | Nintendo Switch Emulator |
...
_Last auto-generated: 2026-08-28T23:40:11.408Z_
