...
![Last update](https://img.shields.io/badge/updated-2026-08-18-9dff57?style=flat-square)
...
|------|---------|-----------|--------|----------|
| 🥇 | Winlator BrunoDev | 14.9M | `v11.1.0` | Winlator |
...
| 12 | Winlator Coffincolors | 804.0K | `winlator_cmod_update_december_2025` | Winlator |
| 13 | RPCSX Android | 803.7K | `v20250425` | Emulator PS3 |
| 14 | GameNative | 777.2K | `v1.1.1` | GameNative |
| 15 | Flycast | 768.8K | `v2.6` | Sega Dreamcast |
| 16 | Dolphin MMJR2 VBI | 736.9K | `U24.07.02-2407` | Nintendo GameCube / Wii |
| 17 | XoDos | 712.1K | `1.0.3-link` | PC Emulator |
| 18 | Winlator Afei | 710.0K | `10.1hotfix-Amod3fix2` | Winlator |
| 19 | Freedreno Turnip CI (Weab-chan) | 681.9K | `25.3.0-devel_bbdd688` | Drivers |
| 20 | APS3e | 587.6K | `2.41` | Emulator PS3 |
| 21 | Winlator Mali | 536.8K | `bionic-mali-1.1` | Winlator |
| 22 | Freedreno Turnip CI (whitebelyash) | 509.0K | `tu_v31` | Drivers |
| 23 | Horizon Emu | 470.4K | `v4` | PC Emulator |
| 24 | Freedreno Turnip CI (StevenMXZ) | 459.3K | `v863.1_a7xx` | Drivers |
| 25 | X360 Mobile | 321.1K | `v0.6.3` | Xbox 360 |
| 26 | Wb64dev | 283.0K | `v10.2` | Winlator |
| 27 | BannerHub (The412Banner) | 274.2K | `v3.8.0` | GameHub |
| 28 | ARMSX2 | 218.8K | `2.6.6.7` | Emulator PS2 |
| 29 | NetherSX2-Turnip | 160.4K | `v0.7` | Emulator PS2 |
| 30 | ExaGear 302 | 158.6K | `v3.0.2.2-egw` | PC Emulator |
| 31 | Winlator Bionic Stredohiri | 121.4K | `26f65e9` | Winlator |
| 32 | Star (fork) | 106.3K | `star-winhub-progrwss` | Winlator |
| 33 | hakuX | 100.2K | `v0.3.1` | Xbox |
| 34 | Pluvia | 98.9K | `v1.3.2` | PC Emulator |
| 35 | Winlator Ajay | 87.8K | `v11.1-hotfix2` | Winlator |
| 36 | Lemuroid | 83.5K | `1.17.0` | All In One |
| 37 | MiceWine | 79.8K | `ba4b91b` | PC Emulator |
| 38 | Winlator X | 77.5K | `v3.0.1-beta` | Winlator |
| 39 | X1 BOX | 75.3K | `1.2.6` | Xbox |
| 40 | Winlator Ref4ik (Drivers/Wine) | 70.4K | `V11` | Drivers |
| 41 | Winlator Ref4ik | 70.4K | `V11` | Winlator |
| 42 | Winlator Bionic jhinzuo | 62.5K | `dev8` | Winlator |
| 43 | Steamlator | 61.7K | `1.7` | Winlator |
...
_Last auto-generated: 2026-08-18T03:21:53.582Z_
