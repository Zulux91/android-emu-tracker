...
| 12 | Winlator Coffincolors | 787.2K | `winlator_cmod_update_december_2025` | Winlator |
| 13 | RPCSX Android | 778.4K | `v20250425` | Emulator PS3 |
| 14 | Flycast | 739.9K | `v2.6` | Sega Dreamcast |
| 15 | Dolphin MMJR2 VBI | 722.2K | `U24.07.02-2407` | Nintendo GameCube / Wii |
| 16 | GameNative | 714.8K | `v1.1.1-prerelease` | GameNative |
| 17 | Winlator Afei | 700.3K | `10.1hotfix-Amod3fix2` | Winlator |
| 18 | XoDos | 692.9K | `1.0.3-link` | PC Emulator |
| 19 | Freedreno Turnip CI (Weab-chan) | 655.7K | `25.3.0-devel_bbdd688` | Drivers |
| 20 | APS3e | 528.8K | `2.40` | Emulator PS3 |
| 21 | Winlator Mali | 496.2K | `bionic-mali-1.1` | Winlator |
| 22 | Horizon Emu | 465.0K | `v4` | PC Emulator |
| 23 | Freedreno Turnip CI (whitebelyash) | 459.1K | `tu_v29` | Drivers |
| 24 | Freedreno Turnip CI (StevenMXZ) | 378.6K | `v863.1_a7xx` | Drivers |
| 25 | Wb64dev | 277.5K | `v10.2` | Winlator |
| 26 | BannerHub (The412Banner) | 237.8K | `v3.8.0` | GameHub |
| 27 | X360 Mobile | 209.2K | `v0.5.3_preview` | Xbox 360 |
| 28 | ExaGear 302 | 152.7K | `v3.0.2.2-egw` | PC Emulator |
| 29 | NetherSX2-Turnip | 134.2K | `v0.7` | Emulator PS2 |
...
| 33 | Winlator Ajay | 83.2K | `v11.1-hotfix2` | Winlator |
| 34 | ARMSX2 | 81.4K | `2.6.5.1` | Emulator PS2 |
| 35 | hakuX | 81.4K | `v0.3.1` | Xbox |
...
_Last auto-generated: 2026-07-25T23:55:35.146Z_
