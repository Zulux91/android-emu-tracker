...
| 12 | Winlator Coffincolors | 804.8K | `winlator_cmod_update_december_2025` | Winlator |
| 13 | RPCSX Android | 804.7K | `v20250425` | Emulator PS3 |
| 14 | GameNative | 779.9K | `v1.1.1` | GameNative |
| 15 | Flycast | 770.0K | `v2.6` | Sega Dreamcast |
| 16 | Dolphin MMJR2 VBI | 737.5K | `U24.07.02-2407` | Nintendo GameCube / Wii |
| 17 | XoDos | 712.8K | `1.0.3-link` | PC Emulator |
| 18 | Winlator Afei | 710.5K | `10.1hotfix-Amod3fix2` | Winlator |
| 19 | Freedreno Turnip CI (Weab-chan) | 682.8K | `25.3.0-devel_bbdd688` | Drivers |
| 20 | APS3e | 589.6K | `2.41` | Emulator PS3 |
| 21 | Winlator Mali | 538.4K | `bionic-mali-1.1` | Winlator |
| 22 | Freedreno Turnip CI (whitebelyash) | 512.3K | `tu_v31` | Drivers |
| 23 | Horizon Emu | 470.7K | `v4` | PC Emulator |
| 24 | Freedreno Turnip CI (StevenMXZ) | 464.9K | `v863.1_a7xx` | Drivers |
| 25 | X360 Mobile | 327.5K | `v0.6.3` | Xbox 360 |
| 26 | Wb64dev | 283.2K | `v10.2` | Winlator |
| 27 | BannerHub (The412Banner) | 275.8K | `v3.8.0` | GameHub |
| 28 | ARMSX2 | 226.4K | `2.6.6.7` | Emulator PS2 |
| 29 | NetherSX2-Turnip | 161.6K | `v0.7` | Emulator PS2 |
...
| 39 | X1 BOX | 76.9K | `1.2.6` | Xbox |
| 40 | Winlator Ref4ik (Drivers/Wine) | 70.8K | `V11` | Drivers |
| 41 | Winlator Ref4ik | 70.8K | `V11` | Winlator |
...
_Last auto-generated: 2026-08-19T02:15:10.436Z_
